<template>
    ...
    <view class="x12 text-center">
		...
		<view class="x12" style="font-size: 12pt; margin-top: 100upx;">
			<navigator url="/pages/center/center" hover-class="none">{{s}}s后，<span style="text-decoration: underline;" @click='gotoctnter'>查看余额</span></navigator>
		</view>
    </view>
	</view>
</template>
