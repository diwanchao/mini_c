		...
		<view class="x12" style="font-size: 12pt;">
			<view class="x12">
				...
				<view class="x12 bg-white padding-big" style="margin-top: 10px;">
					<view class="x-auto" style="width: 160upx;">新登录密码</view>
					<view class="x-auto  padding-left"><input type="text" password="true" v-model="password" placeholder="登录密码"  @input="dlRegBut"></view>
				</view>
				<view class="x12 bg-white padding-big" style="margin-top: 1px;">
