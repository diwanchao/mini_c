...
export default {
  ...
  props: {
    ...
    bgImg: {
      type: String,
      default() {
        return "https://goss1.veer.com/creative/vcg/veer/612/veer-148024919.jpg";
      }
    },
    bgColor: {
      type: String,
  ...
  computed: {
    CustomBar() {
      ...
      if (this.bgColor.includes("bg-shadeTop") > 0) {
        ...
        style["height"] = this.CustomBarHeight + "px";
      }
    ...
    navCustom() {
      ...
      style["height"] = 32 + "px";
      style["margin-left"] = `calc(750upx - 730upx)`;
      // #endif
      return obj2style(style);
    },
    navColor() {
  ...
  onReady() {
    ...
    // #endif
    // #ifdef MP-ALIPAY
    this.CustomBarHeight = systemInfo.statusBarHeight;
...
@font-face {
  ...
  src: url("//at.alicdn.com/t/font_533566_yfq2d9wdij.eot?t=1545239985831#iefix")
    ...
    /* chrome, firefox, opera, Safari, Android, iOS 4.2+*/
      url("//at.alicdn.com/t/font_533566_yfq2d9wdij.svg?t=1545239985831#iconfont")
      format("svg");
  /* iOS 4.1- */
}
